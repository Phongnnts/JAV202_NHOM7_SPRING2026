...
public class DrinkDAO extends BaseDAO<Drink> {
    ...
    public long countAll() {
        EntityManager em = JPAUtil.getEntityManager();
        try {
            Object result = em.createQuery("SELECT COUNT(d) FROM Drink d").getSingleResult();
    ...
    public long countActive() {
        EntityManager em = JPAUtil.getEntityManager();
        try {
            Object result = em.createQuery("SELECT COUNT(d) FROM Drink d WHERE d.active = true").getSingleResult();
            return ((Number) result).longValue();
        } finally {
            em.close();
        }
